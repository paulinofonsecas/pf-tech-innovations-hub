      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="relative">
            <div className="relative z-10 bg-white p-6 rounded-2xl shadow-xl max-w-lg mx-auto lg:ml-0">
            ...
            <div className="absolute top-10 left-10 w-full h-full border-2 border-brand-blue rounded-2xl -z-10 hidden lg:block"></div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <Button className="bg-brand-blue hover:bg-brand-darkBlue mt-4">
              Saiba mais
            </Button>
          </div>
        </div>
